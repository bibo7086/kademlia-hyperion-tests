...
public class KingParser implements Control {
  ...
  /**
   * The ratio between the time units used in the configuration file and the time units used in the
   * Peersim simulator.
   *
   * @config
   */
  ...
  public boolean execute() {
    ...
    //     throw new IllegalParameterException(prefix + "." + PAR_FILE, filename + " does not
    // exist");
    //   }
    // } else {
    //   in =
