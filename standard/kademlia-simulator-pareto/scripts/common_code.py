...
unix_config_files = ["/users/addr777/archive/development/kademlia-tests/standard/kademlia-simulator-pareto/simulator/config/kademlia.cfg"] # List of config file paths
unix_output_dir = "/users/addr777/archive/development/kademlia-tests/standard/kademlia-simulator-pareto/simulator/output/"  # Output directory path
unix_log_dir = "/users/addr777/archive/development/kademlia-tests/standard/kademlia-simulator-pareto/simulator/logs/"  # Log directory path
unix_base_path = "/users/addr777/archive/development/kademlia-tests/standard/kademlia-simulator-pareto/simulator/"
