...
/**
 * This class implements the <code>Group</code> interface of JEP, enabling the configuration system
 * to read integers with arbitrary length.
 */
public class Operators extends Group
    implements IntegralDomainI, HasDivI, OrderedSetI, HasModI, HasPowerI {
